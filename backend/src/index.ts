...
const callModel = async (state: typeof GraphAnnotation.State) => {
  ...
  const systemMessage = {
    role: "system",
    content:
      "You are a CrossFi blockchain assistant. You can help users check wallet " +
      "balances, view transaction history, and send tokens using their configured CrossFi wallet. " +
      "Make sure to validate addresses and amounts before proceeding. " +
      "CrossFi addresses are Ethereum-compatible addresses starting with '0x'.",
  };
